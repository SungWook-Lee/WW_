...
public class office extends Fragment {
    public static final int imgs[] = {R.drawable.os1, R.drawable.os2, R.drawable.os3, R.drawable.os4,
            R.drawable.os5, R.drawable.os6, R.drawable.os7, R.drawable.os8, R.drawable.os9};
    public static final int imgf[] = {R.drawable.of1, R.drawable.of2, R.drawable.of3, R.drawable.of4, R.drawable.of5, R.drawable.of6,
            R.drawable.of7, R.drawable.of8, R.drawable.of9, R.drawable.of10, R.drawable.of11, R.drawable.of12,
            R.drawable.of13, R.drawable.of14, R.drawable.of15, R.drawable.of16, R.drawable.of17, R.drawable.of18};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = (RelativeLayout) inflater.inflate(R.layout.fragment_office, container, false);
        random();
